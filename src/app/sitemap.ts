...
// (/profile/[symbol], /hkex/[code]) are left out on purpose — there's no
// fixed, finite list of valid tickers to enumerate, and Google finds them
// fine by following the on-site search/links once it's crawled the module
// pages below. See .env.local.example for NEXT_PUBLIC_SITE_URL, which this
// reads to build absolute URLs.
