    ...
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation: "Classic merger arb: buy the target at a discount to the offer price, short the acquirer (in a stock deal) to hedge, and profit from the spread narrowing as the deal closes — a direct bet on deal completion.",
      },
      {
        ...
        options: [
          "Fixed income analysts don't react to M&A",
    ...
    quiz: [
      {
        ...
        options: [
          ...
          "There's no real reason — they're interchangeable",
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          ...
          "Heavy real estate depreciation distorts REIT net income in a way that doesn't reflect real economic performance",
          "P/FFO is required by law for all real estate companies",
          "REITs don't have any earnings to measure",
        ],
        correctIndex: 1,
...
A bond trader's real, day-to-day risk isn't just "will rates move" (duration) — it's duration, convexity, *and* the cost and availability of repo financing for whatever they're holding, all at once. Knowing all three exist, and roughly how they interact, is what separates a textbook answer about bonds from one that sounds like it came from someone who's actually thought about how the market functions mechanically.`,
    quiz: [
      ...
      },
      {
        ...
        options: [
          "They're riskier issuers by definition",
          ...
          "Convexity doesn't apply to callable bonds",
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "Repo is short-term financing: sell a bond with an agreement to buy it back slightly higher shortly after — the economic equivalent of borrowing cash against the bond as collateral, which is how most bond dealer inventory actually gets funded.",
      },
    ],
  },
...
The same forward-vs-futures and basis-risk logic applies directly to FX hedging (a company with foreign revenue hedging currency exposure) and interest rate hedging (a company with floating-rate debt hedging against rate rises) — it's a general risk-management framework, not something unique to oil and wheat. Recognizing "what's the basis risk here" is a genuinely useful question to ask about almost any hedge you encounter.`,
    quiz: [
      {
        question: "What's the key structural difference between a forward and a futures contract?",
        options: [
        ...
        correctIndex: 1,
        explanation: "Futures trade on an exchange with a clearinghouse guaranteeing performance; forwards are private, bilateral, and customizable but carry the risk the other party doesn't honor the contract.",
      },
      {
    ...
    quiz: [
      {
        ...
        options: [
          ...
          "To avoid signaling a large order publicly before it's fully executed, which could move the price against them",
          "Dark pools always offer better prices by law",
          "Dark pools are only for retail investors",
        ],
        correctIndex: 1,
        explanation: "A visible large order on a lit exchange can move the price against the trader before they've finished executing — dark pools let large blocks trade without that public signal, reducing market impact.",
      },
      {
    ...
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation: "A straddle profits from a large move in either direction — it's a pure bet on volatility/magnitude, with no view on which direction the move happens in.",
      },
      {
        question: "What's the trade-off of selling a covered call against stock you already own?",
        options: [
        ...
        correctIndex: 1,
        explanation: "Selling the call generates income today, but if the stock rallies past the strike you're obligated to sell at that price — giving up further upside in exchange for the premium collected.",
      },
      {
        ...
        options: [
          "It doesn't affect cost or profit at all",
...
A candidate who can only handle the clean, single-variable depreciation example from Chapter 8 will visibly struggle the moment an interviewer adds a second moving part — "now assume receivables also increased by $15, and there was $5 of stock-based comp" is a completely realistic follow-up, and handling it requires the exact same first-principles tracing skill, just applied simultaneously to more than one line at once. The skill was never really about depreciation specifically — it's about reflexively asking "where did the cash actually go" for any line item, however unfamiliar.`,
    quiz: [
      ...
      },
      {
        ...
        options: [
          "It's a mistake that needs correcting",
          "It's a real expense that reduces net income but involves no actual cash outflow in that period",
          "SBC is never a real expense",
          "It's only relevant for private companies",
        ],
        correctIndex: 1,
        explanation: "SBC is a genuine economic cost (via future dilution) reflected correctly on the income statement, but since no cash actually left the company for it in that period, it's added back — the same non-cash-expense treatment as depreciation.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        options: [
          ...
          "It's a criminal penalty for hostile bidders",
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          ...
          "Only a fraction of directors are up for election each year, so a proxy fight win doesn't immediately deliver full board control",
...
An analyst or investor who only reads the press release sees the story a company's PR team chose to tell. An analyst who reads the actual merger agreement's break fee, MAC clause, and financing conditions sees the real, negotiated allocation of risk between the two parties — genuinely more informative about how confident *both sides* actually are that the deal closes as announced, which is precisely the judgment a merger arbitrage investor (from the very first deep dive in this course) is making with real capital.`,
    quiz: [
      ...
      },
      {
        ...
        options: [
          "They're rarely included in real merger agreements",
    ...
    quiz: [
      {
        ...
        correctIndex: 1,
        explanation: "A one-pager's job isn't completeness — it's earning the reader's attention fast enough that they choose to go deeper, which is a genuinely different writing goal than the full pitch document.",
      },
      {
        question: "Why does a one-pager need a genuinely stated bear case, not a strawman?",
        options: [
          "It's a formality with no real effect on the reader",
          "A missing or weak bear case makes an experienced reader trust the pitch less, since it suggests the thesis hasn't been stress-tested",
          "Bear cases are legally required",
          "It makes the document longer, which is always better",
        ],
        correctIndex: 1,
        explanation: "An experienced reader reads the absence of a real bear case as a red flag — either the analyst hasn't seriously considered the downside, or is hiding it, both of which undermine trust in the rest of the pitch.",
      },
    ],
  },
];
