...
export const FIRM_TYPES: FirmType[] = [
  ...
  },
  {
    ...
    category: "Investment Banking",
    summary:
      "Smaller, advisory-focused firms (e.g. Evercore, Lazard, Moelis, PJT, and regional middle-market shops). Smaller classes, often more technically demanding interviews since there is less brand-name draw doing the work for them.",
    process: [
    ...
    realWorldNotes:
      "Boutiques often expect you to already know the technicals cold by first round, since there are fewer rounds total to figure out if you are capable. \"Why this boutique, specifically\" is asked more seriously here than \"why banking\" in general.",
  },
  {
    id: "asset-management",
  ...
  },
  {
    ...
    realWorldNotes:
      "Because HireVue plays such a large role here, practicing answering out loud (or in writing first, then out loud) matters more for this firm type than almost any other. A strong written answer that you have not rehearsed saying can come across flat on video.",
  },
];
...
export const TECH_QUESTIONS: TechQuestion[] = [
  {
    ...
    answer:
      "Income statement: operating income falls $10, taxes fall $2.50 (at 25%), net income falls $7.50. Cash flow: start from net income (−$7.50), add back the non-cash $10 depreciation, so cash from operations is actually UP $2.50. Balance sheet: cash up $2.50, net PP&E down $10 (assets down $7.50 net); retained earnings down $7.50 (equity down $7.50). It balances. See the full worked version in Lesson 2: Three-Statement Modeling.",
  },
  {
    id: "wc-change",
    category: "Accounting & Three-Statement",
    ...
    answer:
      "Net income is unaffected (the sale was already booked as revenue). But cash flow from operations falls by $20. The company recorded the sale but has not actually collected the cash yet, so the increase in receivables is a real use of cash that has to be subtracted out on the cash flow statement.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes, it means accumulated losses (or large debt-funded buybacks/dividends) have eroded equity below zero, so liabilities exceed assets on a book basis. It does not automatically mean insolvency (book value is not market value, and the company can still generate real cash flow). Leveraged buyout targets and some mature cash-generative businesses with aggressive buyback programs commonly show negative book equity.",
  },
  {
    id: "dcf-walkthrough",
  ...
  },
  {
    ...
    category: "Valuation & Technicals",
    firmTypes: ["bulge-bracket-ib", "elite-boutique-ib"],
    question: "When is an M&A deal accretive vs. dilutive, and does accretive automatically mean it is a good deal?",
    answer:
  ...
  },
  {
    ...
    category: "Valuation & Technicals",
    firmTypes: ["bulge-bracket-ib", "asset-management"],
    question: "I own a call option and the stock does not move at all for a week. What happens to my option's value, and why?",
    answer:
  ...
  },
  {
    ...
    category: "Deal & Case",
    firmTypes: ["bulge-bracket-ib", "elite-boutique-ib", "asset-management"],
    question: "Tell me about a real M&A deal you have been following. Walk me through it.",
    answer:
...
export const PYMETRICS_GAMES: PymetricsGame[] = [
  ...
  },
  {
    ...
    description:
      "You are given a small sum and decide how much to send to an anonymous counterpart; whatever you send gets multiplied, and the counterpart decides how much to send back. Measures your baseline trust in a stranger's reciprocity.",
    playable: false,
  },
  {
    id: "money-exchange-2",
    ...
    description:
      "The reverse role of the trust game: you are the one deciding how much to send back after receiving a multiplied amount. Measures how fairly you treat a counterpart when you hold the power in the exchange.",
    playable: false,
  },
  {
    id: "keypress",
...
export const HIREVUE_PROMPTS: HireVuePrompt[] = [
  {
    ...
    tip: "Name something real and specific: a deal, a fund, a practice area, a person you have spoken to, not \"strong culture\" or \"great people,\" which every firm claims about itself.",
  },
  {
    id: "why-ib",
    category: "Motivational",
    ...
    tip: "A strong answer contrasts the actual day-to-day (deal execution, pitch books, live transactions) against the alternatives you are implicitly ruling out, showing you understand the real difference, not just that banking sounds prestigious.",
  },
  {
    ...
    tip: "Practice a tight 90-second version. Chronological, but every sentence should build toward why you are a fit for this specific seat. Cut anything that does not.",
  },
  {
    id: "conflict-team",
    category: "Behavioral",
    ...
    tip: "Use a real, specific example with a real outcome, including what you would do differently, if relevant. Structure it: situation, your specific action, the result. Vague or hypothetical answers read as unprepared.",
  },
  {
    id: "failure",
    category: "Behavioral",
  ...
  },
  {
    ...
    tip: "State your structure out loud before diving in: market size/growth, competitive intensity, client capability fit, financial viability, risk. On video, narrating your structure matters more than it would face to face, since the interviewer cannot nod you along.",
  },
  {
    id: "handle-pressure",
    category: "Behavioral",
  ...
  },
  {
    ...
    category: "Behavioral",
    firmTypes: ["bulge-bracket-ib", "elite-boutique-ib", "asset-management", "mbb", "other-consulting"],
    prompt: "What is a genuine weakness of yours, and what are you doing about it?",
    tip: "A real weakness with a real, ongoing corrective action beats a disguised strength (\"I am too much of a perfectionist\") every time. Interviewers have heard the disguised version thousands of times.",
  },
];
