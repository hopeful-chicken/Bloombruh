...
`,
    toolkit: `## Pitch deck template
Download the [Nintendo pitch-deck template (.pptx)](/api/pitch-template?id=nintendo&code=vq55jh68%26*) — 9 slides built to match the real Varsity/OAF-style decks these templates are modeled on: dense, chart-driven, colour-coded bear/base/bull, not a bullet-point skeleton. The valuation slide and Sources appendix are already filled in with real numbers; everything marked [INSERT] tells you exactly what to research and drop in yourself.
...
`,
    toolkit: `## Pitch deck template
Download the [ASML pitch-deck template (.pptx)](/api/pitch-template?id=asml&code=vq55jh68%26*) — 9 slides built to match the real Varsity/OAF-style decks these templates are modeled on: dense, chart-driven, colour-coded bear/base/bull, not a bullet-point skeleton. The valuation slide and Sources appendix are already filled in with real numbers; everything marked [INSERT] tells you exactly what to research.
...
`,
    toolkit: `## Pitch deck template
Download the [TSMC pitch-deck template (.pptx)](/api/pitch-template?id=tsmc&code=vq55jh68%26*) — 9 slides built to match the real Varsity/OAF-style decks these templates are modeled on: dense, chart-driven, colour-coded bear/base/bull, not a bullet-point skeleton. The valuation slide and Sources appendix are already filled in with real numbers; everything marked [INSERT] tells you exactly what to research.
...
`,
    toolkit: `## Pitch deck template
Download the [Maersk pitch-deck template (.pptx)](/api/pitch-template?id=maersk&code=vq55jh68%26*) — 9 slides built to match the real Varsity/OAF-style decks these templates are modeled on: dense, chart-driven, colour-coded bear/base/bull, not a bullet-point skeleton. The valuation slide and Sources appendix are already filled in with real numbers; everything marked [INSERT] tells you exactly what to research.
...
`,
    toolkit: `## Pitch deck template
Download the [Domino's Pizza Group pitch-deck template (.pptx)](/api/pitch-template?id=dominos-pizza-group&code=vq55jh68%26*) — 9 slides built to match the real Varsity/OAF-style decks these templates are modeled on: dense, chart-driven, colour-coded bear/base/bull, not a bullet-point skeleton. The valuation slide and Sources appendix are already filled in with real numbers; everything marked [INSERT] tells you exactly what to research.
...
`,
    toolkit: `## Pitch deck template
Download the [Microsoft pitch-deck template (.pptx)](/api/pitch-template?id=microsoft-ai-industry&code=vq55jh68%26*) — 9 slides built to match the real Varsity/OAF-style decks these templates are modeled on: dense, chart-driven, colour-coded bear/base/bull, not a bullet-point skeleton. The valuation slide and Sources appendix are already filled in with real numbers; everything marked [INSERT] tells you exactly what to research.
