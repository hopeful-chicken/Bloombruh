...
The reference point I kept coming back to is a 1997 paper by Robert Greer, a finance academic, in the Journal of Portfolio Management. It is still considered the standard definition, and he revisited it himself in 2018. Greer defines an asset class as a group of things that share real economic similarities with each other, and that are clearly different from things outside the group. When he revisited the idea two decades later, he added an important condition: the group should be things people can actually invest in, not just things that exist. That distinction ends up mattering a lot here.
...
The Charizard case study below makes the point better than the theory does on its own. PSA is the leading company that authenticates and grades trading cards: it checks a card for centering, corners, edges, and surface condition, then assigns a numerical grade, with PSA 10, or "gem mint," meaning as close to a perfect, flawless copy as the scale allows. The PSA 10, first edition Base Set Charizard is the single most tracked individual card in the hobby, and its real sale history is a useful test of whether this is actually a boring, stable thing to own.
...
The comparison people always want is the $30 one. Thirty dollars in the S&P 500 in January 1999, with dividends reinvested, is worth roughly $261 today. Thirty dollars spent on a Charizard that later graded PSA 10 would be worth $550,000 today, around 18,000 times the money. Worth keeping in mind: this is the single most extreme surviving outcome out of billions of printed cards, and the 1999 entry price is an assumption about what a pack or a raw card cost at the time, not a documented sale.
...
Treating "is this a bubble" as some future question stopped making sense once I looked closely at 2026 data, because for half of this market, it has already been answered.
...
A modern chase card's supply can grow to meet demand, because the company can simply print more of that set (a new Millennium Print Group printing facility is adding capacity for exactly this). A 1999 card cannot be reprinted.

That is where most commentary on this stops. I think it stops one step too early.

## Why the "vintage is scarce" argument is weaker than it looks

The print run of a 1999 card is fixed, that much is true. But the print run is not actually what determines its price. What determines the price is the number of copies sitting in a PSA 10 holder, because that specific object, a card that has already been graded a perfect 10, is what actually trades at the headline prices, and that population is created by a grading company, not by Nintendo.
...
[Look up Nintendo's own stock (NTDOY) on this site](/profile/NTDOY) to see that blended picture for yourself.
