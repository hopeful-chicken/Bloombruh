...
**The trigger:** A Q3 FY2026 trading update (nine months to 30 June 2026) raising full-year guidance again, to roughly 42% operating profit growth, on top of the earlier £236m Peerless Aerospace Fastener acquisition.
...
Read the multiples as a ladder: 8x average across the LTM, \~9x on the seven most recent, c.11x for CDM. Two readings are both true. The bull reading: even at 11x, CDM is priced at a fraction of Diploma's own \~24x EV/EBITDA, so the buy-low/sell-high arbitrage that powers the whole model still holds on every deal. The bear reading: the average is drifting up, and the largest deal of the year is the most expensive — a deliberate, strategic premium for US defence exposure. The discipline question is now answered deal by deal, and the 20% return hurdle on acquisitions is the dated, checkable test.
...
- Share price \~7,335p as of 19 August 2026 (52-week range 4,970p–7,755p)
...
- Slide 2 needs a 12-month price chart vs the FTSE 100 with the Q3 trading update and CDM completion dates annotated — screenshot or rebuild it from stooq.com data. Peerless predates a 12-month window, so it belongs in the M&A-history slide, not this chart.
