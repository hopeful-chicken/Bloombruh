...
- **The division doing the work:** Controls grew +26% organically at a 33.5% adjusted margin (+430bps) on aerospace, defence, datacentre and energy demand, with Peerless singled out for "continued outstanding performance" — early tracking evidence for the deal's stated ~+8% year-one EPS accretion. Windy City Wire grew +16%, in line with its 17% post-acquisition average. The honest caveat, disclosed by the CEO himself: excluding Peerless, the portfolio grew high single-digit organic. That is still comfortably ahead of the 5% financial model, which says something real about portfolio quality, but it also means one exceptional acquisition is doing genuine work in the headline number, and management itself guides to Peerless moderating "towards more typical growth rates" in H2.
...
- Peerless Aerospace Fastener acquisition: £236m, \~+8% EPS accretion in year one; H1 commentary: "continued outstanding performance"
