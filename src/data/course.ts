// "Finance 101" is a 13-chapter, start-to-end course for someone who just
// got into finance and does not yet know which seat they want: S&T, IBD,
...
If you are new to finance, the job titles alone are confusing: "S&T," "IBD," "buy-side," "sell-side," "the Street." This chapter is the map: what each major seat actually does, who it serves, and how it makes money. Nothing here requires prior knowledge. That is the point of starting here.

## The one distinction that organizes everything else: buy-side vs. sell-side

**Sell-side** firms sell something to clients: advice, market access, research, capital-raising services. Investment banks are the classic sell-side example: they do not (mostly) invest their own money for their own account; they serve *other people's* money and other companies' needs, and get paid fees or spread for doing it.

**Buy-side** firms manage actual pools of money and invest it directly: asset managers, hedge funds, private equity firms, pension funds. They are the sell-side's clients. When you hear "the buy-side," think: the people actually deciding what to buy and sell with real capital.
...
Investment bankers advise companies on two things: **raising capital** (helping a company sell new stock via an IPO, Equity Capital Markets (ECM), or issue new bonds, Debt Capital Markets (DCM)) and **M&A advisory** (advising a company that is buying or selling another company). Banks get paid a fee, often a percentage of the deal or capital raised, which is why bankers are motivated to get deals *done*, not just to give good advice in the abstract.
...
Similar to asset management in that they invest pooled capital, but with far more flexible mandates. They can short stocks, use leverage, trade derivatives, and pursue strategies public mutual funds usually cannot. The classic fee structure, "**2 and 20**," means a 2% annual management fee plus 20% of profits, which is why hedge funds are far more performance-incentivized than a typical asset manager.
...
PE firms buy entire companies (often using significant borrowed money, a **leveraged buyout**, or LBO), try to improve them operationally over a multi-year hold period, and sell them for a profit. It is a different time horizon and skill set from public-markets investing. PE is closer to operating a business than trading a security.

## Where this course is going

This course does not assume you already know which of these seats you want. Most first-years do not. It is built to give you a real, working knowledge of all the major asset classes (equities, fixed income, commodities, FX) and both sides of the business (the deal-making side and the markets side), with hands-on exercises using this site's own live tools, so you can actually figure out what pulls you in rather than guessing from a job title.`,
    tryIt: [
      {
    ...
    quiz: [
      ...
      {
        question: "What is the core difference between sales & trading and asset management?",
        options: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "2% of assets under management per year, plus 20% of any profits generated. That is the classic hedge fund fee structure, and why hedge funds are unusually performance-incentivized.",
      },
    ],
  },
...
A **52-week range** shows a stock's lowest and highest price over the past year, a quick gut-check for whether a current price is near its highs (often read as strength or, less charitably, as "expensive") or lows (weakness, or "cheap," the same ambiguity as a low P/E). **Volume**, meaning how many shares traded, matters alongside price: a big price move on unusually high volume signals real conviction behind the move; the same move on thin volume is a weaker signal.`,
    ...
    quiz: [
      {
        question: "A company trades at $80/share with 10 million shares outstanding. What is its market cap?",
      ...
      },
      {
        ...
        options: [
          ...
          "EV adjusts market cap for the company's debt and cash, reflecting what you would really pay to own the whole business",
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "Secondary-market trades are between investors. The company itself is not a party to the transaction and receives no cash from it, even though the trading sets the price the company gets judged on.",
      },
      {
  ...
  // ————————————————————————————————————————————————————————————
  {
    ...
    track: "Asset Classes",
    tagline: "Bonds, yield curves, and credit spreads, the other half of the market that is not stocks",
    body: `# Fixed Income & Credit

Chapter 2 covered equities. This chapter covers the asset class that is actually larger by total value and just as central to both banking (DCM, leveraged finance) and asset management: fixed income. What a bond actually is, how it is priced, what a yield curve means, and how credit risk gets priced into spreads.

## What a bond actually is

A bond is a loan, packaged as a tradeable security. When you buy a bond, you are lending money to whoever issued it (a government, a company) in exchange for two things: regular interest payments (the **coupon**) and your money back at a fixed future date (the **face value**, paid at **maturity**).

That is it. The entire instrument is defined by three numbers: **face value** (usually $1,000 or $100 per bond, the amount you get back), **coupon rate** (the annual interest rate, paid on the face value), and **maturity** (when you get the face value back).
...
**Yield to maturity (YTM)** is the more complete version, the total annualized return you would earn if you bought the bond today and held it to maturity. This is the number that actually gets quoted and compared across bonds.

**Worked example (current yield, the simplest version):** current yield = annual coupon ÷ price. A bond with a $1,000 face value and a 4% coupon pays $40/year. If it is trading at $950: current yield = $40 ÷ $950 = **4.2%**, already above the 4% coupon rate, exactly because you are paying less than face value for the same fixed $40 payment. (Full YTM refines this further by also folding in the gain from $950 back up to $1,000 at maturity. Current yield is the quick approximation.)
...
**Inverted yield curve:** short-term yields exceed long-term yields, one of the most closely watched recession-warning signals in markets. The logic: if investors expect the central bank to cut rates sharply later (because they expect a slowdown), they will accept a lower yield on long-dated bonds now to lock in today's still-higher rate before it disappears.
    ...
    quiz: [
      {
        ...
        options: ["It rises", "It falls", "It is unaffected", "It depends only on the issuer's credit rating"],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ["Yield equals the coupon rate", "Yield is lower than the coupon rate", "Yield is higher than the coupon rate", "There is no relationship"],
        correctIndex: 2,
      ...
      },
      {
        ...
        options: [
          ...
          "Nothing. It is a random, meaningless pattern",
        ],
        correctIndex: 1,
...
Equities and fixed income get most of the attention in a typical finance education. Commodities and currencies are just as real an asset class, and "what is your view on GBPUSD" or a question about oil markets is a genuinely common S&T and macro-fund interview topic that trips up candidates who have never thought seriously about either.
...
- **Contango**: futures prices are *higher* than the current spot price, common when storage costs matter (you are paying someone to hold the physical commodity until you need it) or supply is currently ample.
- **Backwardation**: futures prices are *lower* than the current spot price, often signaling near-term scarcity: the market is willing to pay more for the commodity *right now* than for delivery later, a real, urgent supply-demand signal.
...
A currency pair like **GBP/USD = 1.27** means 1 British pound buys 1.27 US dollars. GBP is the **base currency**, USD is the **quote currency**. If GBP/USD *rises*, the pound has strengthened against the dollar. Every FX move is, by definition, about *both* currencies at once. There is no such thing as "the dollar went down" without some other currency going up against it.
...
If the Fed holds rates meaningfully higher than the ECB, that tends to support USD strength against EUR, all else equal, since real money is incentivized to hold dollar-denominated assets for the extra yield. This is why an FX trader watches central bank decisions as closely as an equity analyst watches earnings.
...
**Worth knowing for an interview:** carry trades work smoothly until they do not. A sudden shift in risk sentiment can cause a rapid, painful unwind, which is why "carry trades unwinding" is a recurring phrase in real market-stress episodes.

## Purchasing power parity: the long-run anchor

**Purchasing Power Parity (PPP)** is the idea that, in the long run, exchange rates should adjust so the same basket of goods costs the same amount in any currency (the Economist's "Big Mac Index" is a real, simplified illustration). PPP is a genuinely poor *short-term* predictor, since rates can deviate from it for years, but it is a real anchor over long horizons. A strong interview answer references both: PPP as the long-run gravity, rate differentials and flows as what actually moves a pair day to day.
...
Naming these four inputs, and being explicit about which one you are weighting most and why, is a dramatically stronger interview answer than a directional guess with no framework behind it.`,
    tryIt: [
      {
        label: "Read the Pokemon Cards write-up",
        href: "/analysis/pokemon-cards-as-an-asset-class",
        moduleColor: "pokemon",
        description: "A real, concrete commodity-like market: production data, a real volatility case study, and an actual verdict on whether it is worth treating as an asset class.",
      },
      {
        label: "Open Central Bank Room",
        href: "/macro",
        moduleColor: "macro",
        description: "Compare two real central banks' current policy rates, the rate differential that is the biggest single driver of currency moves.",
      },
    ],
    quiz: [
      {
        ...
        options: [
          ...
          "Commodities cannot legally be traded any other way",
        ],
        correctIndex: 2,
        explanation: "Futures let producers, consumers, and speculators manage or take a view on price risk without ever touching the underlying physical commodity. That is the actual mechanism most commodity trading runs on.",
      },
      {
        question: "A commodity's futures price is lower than its current spot price. What is this called, and what does it often signal?",
        options: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "GBP is the base currency. A rising GBP/USD means each pound now buys more dollars, meaning the pound has strengthened (equivalently, the dollar has weakened against it).",
      },
      {
  ...
  // ————————————————————————————————————————————————————————————
  {
    ...
    track: "The Seats",
    tagline: "Market makers, spreads, and order books, what a trading desk does that is not just guessing direction",
    body: `# Sales & Trading: How Markets Actually Trade

Chapter 1 introduced S&T as a seat. This chapter is about the actual mechanics: what "making a market" means, why a trading desk's job is not mostly about predicting whether a stock goes up or down, and how liquidity itself becomes something to manage.
...
## Why the bid-ask spread is not constant

The spread widens or narrows based on real risk. A highly liquid, heavily traded stock (huge daily volume, many market participants) typically has a tight spread, since lots of competition to make that market keeps it efficient. A thinly traded stock, or *any* stock right before a highly uncertain event (an earnings announcement, a major macro release), sees spreads widen. The market maker is compensating themselves for the extra risk of being caught holding inventory right as the price potentially jumps.

## Managing inventory risk: the actual skill

When a market maker buys from a client, they now hold that position, **inventory**, and are exposed to the price moving against them before they can offload it. A real trading desk is not trying to predict where the market goes; it is trying to manage the risk of the inventory that client flow *forces* it to hold, often by adjusting quotes (skewing the bid/ask to attract flow that reduces an unwanted position) or hedging with a related, more liquid instrument.

## What a trading desk's day actually looks like

It is far less "placing directional bets" than pop culture suggests, and far more: taking client orders, managing the resulting inventory and risk in real time, adjusting quotes as conditions change, and coordinating with sales on what clients are asking for. The desks that do take more directional risk (often called "prop-adjacent" flow, though true proprietary trading at banks is heavily regulated today) are a smaller slice of what most of S&T actually does day to day.

## Try it yourself

The best way to build real intuition for this chapter is not reading more about it. It is doing it. This site has an actual, playable market maker simulation below.`,
    tryIt: [
      {
    ...
    quiz: [
      {
        ...
        options: [
          ...
          "Nothing. It is an arbitrary regulatory requirement",
          "The cost of executing on a specific exchange",
        ],
        correctIndex: 1,
        explanation: "The bid-ask spread compensates a market maker for providing continuous liquidity and for the risk of holding inventory that could move against them before it is offloaded.",
      },
      {
        question: "What does a limit order guarantee that a market order does not?",
      ...
      },
      {
        ...
        options: [
          ...
          "It is a fixed rule with no real economic reason",
        ],
        correctIndex: 2,
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "Most of S&T's real activity is client-flow-driven: taking orders, making markets, and managing the risk that flow creates. It is closer to a service business than a directional betting desk.",
      },
    ],
  },
...
The market-making chapter showed a desk managing risk from client flow in the underlying stock. Options desks manage a wider set of risks simultaneously (delta, gamma, vega all at once): the same core skill of continuously hedging and re-pricing risk, just across more dimensions.`,
    ...
    quiz: [
      {
        question: "A call option's strike is $50, and the stock trades at $45. What is its intrinsic value?",
        options: ["$5", "$0", "$45", "-$5"],
        correctIndex: 1,
      ...
      {
        question: "You own a call option. A week passes and the stock does not move at all. What happens to your option's value, and why?",
        options: [
          "It is unchanged, since the stock did not move",
          "It rises, due to gamma",
          "It falls, due to theta (time decay) with no offsetting favorable move",
          "It is impossible to say without knowing delta",
        ],
        correctIndex: 2,
...
A **passive** fund simply tracks an index (like the S&P 500) as closely and cheaply as possible, with no attempt to pick winners, just broad, low-cost exposure. An **active** fund's manager makes deliberate decisions to deviate from an index, aiming to outperform it, and charges a higher fee for that attempt.

The honest, well-documented tension: most active managers, most of the time, do not reliably beat their benchmark after fees, which is exactly why passive investing has grown enormously. The counter-argument active managers make: markets are not perfectly efficient everywhere, and skilled stock-picking or risk management can add real value, particularly in less-covered corners of the market. Both sides of this debate are real and worth understanding, not a settled question.
...
- **VaR (Value at Risk)**: an estimate of the maximum loss a portfolio is likely to experience over a given time horizon, at a given confidence level. "1-day 95% VaR of $1 million" means: on 95% of days, you do not expect to lose more than $1 million, and, importantly, on the remaining 5% of days, you could lose more, sometimes significantly more (VaR describes a threshold, not a worst-case cap).
- **CVaR (Conditional VaR)**: the *average* loss in exactly those worst-case scenarios VaR does not fully describe, a more complete picture of true tail risk.
...
This site's own Portfolio Risk Simulator computes exactly these numbers (Sharpe ratio, VaR, CVaR) on a real portfolio you build across 10 asset classes, via an actual 500-path Monte Carlo simulation. Reading about these concepts is one thing; watching your own portfolio's Sharpe ratio change as you add an uncorrelated asset class is a much faster way to actually understand diversification.`,
    ...
    quiz: [
      {
        question: "What is the core difference between active and passive investing?",
        options: [
      ...
      },
      {
        ...
        options: [
          "It does not. More assets always means more risk",
          "Because assets that do not move in lockstep smooth out each other's price swings",
          "Only if the new asset has a higher expected return",
          "Diversification is a myth with no mathematical basis",
        ],
        correctIndex: 1,
        explanation: "This is a genuine, provable result: combining assets whose price moves are not tightly linked reduces the combined portfolio's volatility, since their swings partially offset rather than compound.",
      },
      {
        ...
        options: [
          ...
          "It is a guarantee, not an estimate",
        ],
        correctIndex: 1,
...
This is, honestly, the single most commonly failed technical question in real banking interviews, not because it is conceptually hard, but because most candidates have only ever seen the three statements separately, never watched them actually move together. Everything from here to the end of this course (M&A, valuation, reading a real deal) leans on this linkage, so it is worth building properly now.
...
Every cash flow statement line item answers one question: for this specific change, where did the actual cash go (or come from), and does that match what the income statement or balance sheet implied? If revenue went up but a receivable also went up by the same amount, the cash has not arrived yet. If an expense was booked but no cash left the building, add it back. The income statement charged you for something that is not a real cash outflow this period.`,
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          "It is a mistake in the income statement that needs correcting",
          "Because it is a non-cash expense: no actual cash left the company for it",
          "To make cash flow look artificially higher",
          "Depreciation is never added back",
        ],
        correctIndex: 1,
        explanation: "Depreciation reduces accounting profit but is not an actual cash outflow. Adding it back reconciles net income to real cash generated.",
      },
      {
        question: "Accounts receivable increases by $20 (a customer was billed but has not paid yet). What happens to cash flow from operations?",
        options: [
          "It rises by $20",
          "It falls, since the revenue was booked but the cash has not been collected",
          "It is unaffected",
      ...
      },
      {
        ...
        correctIndex: 2,
        explanation: "The balance sheet must always balance: assets = liabilities + equity. That is exactly the check that catches an error in your three-statement logic.",
      },
    ],
  },
...
**Capital markets** work (ECM and DCM, from Chapter 1) is about *raising* money: helping a company sell new shares or issue new bonds, and pricing that offering correctly (price it too high and it does not sell; too low and the company leaves money on the table).
...
- **Growth**: organic growth (building new products, entering new markets yourself) is often slower than buying a company that is already there.
...
**AOL-Time Warner (2000)** is one of the most commonly cited cautionary tales in M&A history: a merger announced near the peak of the dot-com boom, between an internet company (AOL) and a traditional media conglomerate (Time Warner), that is widely regarded as having destroyed enormous shareholder value in the years after, largely due to a severe culture clash between the two organizations and the collapse of the dot-com valuation the deal was priced on. It is taught constantly as the case study for "a strategically plausible-sounding deal can still fail badly if the price is wrong or the two organizations simply cannot integrate."
...
## Recent M&A: why this chapter will not give you a list
    ...
    tryIt: [
      {
        ...
        href: "/analysis",
        moduleColor: "analysis",
        description: "Real, dated write-ups on breaking market and deal stories, the actual current-events layer this chapter deliberately does not try to replace.",
      },
      {
        label: "Open Markets Overview",
        href: "/markets",
        description: "Sector-by-sector trends, which is usually where you will first spot the conditions (consolidation pressure, cheap financing, a struggling sub-sector) that precede a wave of M&A.",
      },
    ],
    quiz: [
      {
      ...
      },
      {
        ...
        options: [
          "They do not. Regulators only care about foreign buyers",
          "Consolidating direct rivals can reduce competition and increase pricing power",
          "It is purely a tax issue",
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "It is one of the most widely taught cautionary case studies in M&A: a strategically plausible deal that is broadly regarded as having failed badly post-close.",
      },
      {
        question: "Why does this chapter not list specific \"recent\" M&A deals?",
        options: [
          "Recent deals do not matter for learning M&A",
          ...
          "There is no way to research real deals",
...
1. **Forecast unlevered free cash flow** for 5ish years, starting from revenue, applying a margin assumption to get to EBIT, tax-affect it, add back D&A, subtract capex and the change in net working capital.
...
3. **Take the peer median** (not average, since one outlier should not swing the read).
...
Pick one real, recent, sizable public M&A deal, something large enough to have real analyst coverage, not an obscure small-cap transaction. This site's own My Analysis is a good place to find one already being tracked. Answer, in writing: what is the consideration mix, what premium was paid, what multiple does that imply, how did *both* stocks react on announcement day and why, and what regulatory risk sits between announcement and close. Then find one piece of real analyst or press skepticism about the deal, and one piece of real support for it: the same "evidence on both sides, no forced verdict" discipline this site's own Hype vs Fundamentals module is built around.`,
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ["0-5%", "20-40%", "80-100%", "There is no typical range"],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          ...
          "It is illegal to trade the acquirer's stock around announcement",
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "A deal spread reflects the market pricing in real probability the deal does not close as announced. Regulatory risk (especially in concentrated industries) is a common driver.",
      },
    ],
  },
...
Every earlier chapter built one piece: equities, rates, FX, commodities, deals, valuation. This chapter is about putting those pieces together into an actual daily habit: how to look at "the market" on any given day and have a real, structured read on what is happening, instead of just reacting to headlines.

## Sector rotation: money moving, not just totals moving

Markets rarely move as one uniform block. **Sector rotation** describes money flowing out of one part of the market and into another as the economic cycle, interest rate expectations, or a specific narrative shifts. For example, money moves from richly-valued growth/tech names into cheaper, more defensive sectors when investors get nervous about rates or growth, and the reverse happens when optimism returns. Watching *which* sectors are leading or lagging a broad index move, not just the index level itself, is usually more informative than the headline number alone.

## Narrative vs. fundamentals: the distinction that matters most

A price move can be driven by two very different things: **fundamentals** (an actual, measurable change: an earnings beat, a rate decision, a real change in demand) or **narrative** (a story gaining momentum, meaning excitement, fear, a theme catching on, that outruns any current, measurable evidence for it). Both are real and both move prices; the skill is telling them apart, and asking, for any given move: *what specific evidence is this being priced on, and is that evidence actually here yet, or just expected?*
...
This is a habit, not a one-time lesson. The more real days you run this framework against, the faster it becomes second nature.`,
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          "It does not. Rate decisions only affect bond prices",
        ...
        correctIndex: 1,
        explanation: "A rate change is a genuine, mechanical input into bond pricing (Ch.3), FX rate differentials (Ch.4), and equity discount rates (Ch.10) all at once, which is why it is one of the most closely watched events across every asset class.",
      },
      {
        question: "In the practical framework from this chapter, what is the last question to ask about any market move?",
        options: [
        ...
        correctIndex: 1,
        explanation: "After identifying what moved, why, and whether it is fundamentals- or narrative-driven, the final practical question is durability: whether the move is likely to persist or fade.",
      },
    ],
  },
...
Twelve chapters in, you have covered every major asset class, most of the major seats in the industry, the accounting foundation, and the four core valuation methods. This capstone does not teach a new concept. It is the exercise that makes you actually use all of them together, on one real company, the way an analyst genuinely would.

## What a real pitch actually contains

A defensible investment pitch is not a prediction. It is a structured argument, and every genuinely good one contains the same core pieces:
...
2. **Valuation**: a real number, built from a real method (Chapter 10's DCF or comps), not a vibe. What is it worth, and why.
...
4. **The bear case, argued honestly**: the strongest real argument *against* your own thesis, not a straw man. A pitch that cannot articulate a real bear case has not actually stress-tested itself.
    ...
    quiz: [
      {
        ...
        options: [
          ...
          "It is specific enough to be provably right or wrong later, not just a general good feeling",
          "It must always be bullish",
          "It does not need any supporting valuation",
        ],
        correctIndex: 1,
        explanation: "\"This is a good company\" cannot really be tested. \"The market is underpricing X because of Y\" can. That specificity is what makes a thesis a real, checkable claim rather than just a vibe.",
      },
      {
        question: "Why does a genuinely good pitch include an honestly argued bear case?",
        options: [
          "It is a formality nobody actually reads",
          "Because a thesis that cannot survive its strongest counterargument has not actually been stress-tested",
      ...
      {
        question: "According to this capstone, what is the actual point of comparing your own pitch to the real ones in My Analysis?",
        options: [
          ...
          "There is no real value in doing this",
