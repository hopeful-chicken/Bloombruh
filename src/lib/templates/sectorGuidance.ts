...
export const TEMPLATE_SECTORS: SectorGuidance[] = [
  ...
  },
  {
    ...
    notes: [
      "This template uses a dividend-discount model, not an enterprise-value DCF — that is deliberate, not a simplification. For a bank, debt and deposits are the raw material of the business rather than financing on top of it, so \"enterprise value\" and \"free cash flow after capex\" don't describe anything meaningful. FIG analysts value the equity directly: project earnings, apply a payout ratio, discount the dividend stream at the cost of equity.",
      ...
      "Regulatory capital constrains payouts in reality — a bank can't pay out earnings its capital ratios need. Treat the payout-ratio assumption as the lever it really is.",
    ],
  },
  {
    id: "healthcare",
